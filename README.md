...
This repo includes `.github/workflows/release.yml`. Pushing a tag like `v0.1.5` builds release artifacts for Windows and macOS Apple Silicon and uploads them to a GitHub Release through `tauri-apps/tauri-action`.
